...
Every detail in the game is generated by a LLM (Venice API by default).
...
generated by the Venice language model API.
<<<<<<< ours
=======

You can run the game in:

1. **Terminal mode** (classic): `python advent.py`
2. **Simple web UI**: `python web_ui.py` and open the preview/browser URL.
>>>>>>> theirs
